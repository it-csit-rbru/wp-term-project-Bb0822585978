            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        ...
                        $sql = "insert into continent (ct_name) values ('$ct_name')";
                        echo $sql;
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มทวีป $ct_name เรียบร้อยแล้ว<br>";
                        echo '<a href="continent_list.php">แสดงทวีปทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="continent_add" action="<?php echo $_SERVER['PHP_SELF']?>">
