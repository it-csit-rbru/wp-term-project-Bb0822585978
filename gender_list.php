        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    <h2>เพศ</h2>
                    <a href="gender_add.php" class="btn btn-link">เพิ่มเพศ</a>
                        ...
                        <tbody>
                            <?php
                                ...
                                while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
                                    ...
                                    echo '<td>';
                            ?>
                                <a href="gender_edit.php?g_id=<?php echo $row['g_id'];?>" class="btn btn-warning">แก้ไข</a>
                                <a href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='gender_delete.php?g_id=<?php echo $row["g_id"];?>'}" class="btn btn-danger">ลบ</a>
                            <?php
                                    echo '</td>';
                                    echo '</tr>';
                                }
