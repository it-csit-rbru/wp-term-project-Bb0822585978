        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-9 col-lg-9">
                    <h2>ทวีป</h2>
                    <a href="continent_add.php" class="btn btn-link">เพิ่มทวีป</a>
                    <table class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>รหัส</th>
                                <th colspan="2">ชื่อทวีป</th>
                            </tr>                
                        </thead>
                        <tbody>
                            <?php
                                ...
                                while (($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) != NULL) {
                                    ...
                                    echo '<td>';
                            ?>
                                <a href="continent_edit.php?ct_id=<?php echo $row['ct_id'];?>" class="btn btn-warning">แก้ไข</a>
                                <a href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='continent_delete.php?ct_id=<?php echo $row["ct_id"];?>'}" class="btn btn-danger">ลบ</a>
                            <?php
                                    echo '</td>';
                                    echo '</tr>';
                                }
