            ...
            <div class="row">
                ...
                <?php
                    if(isset($_GET['submit'])){
                        $g_name = $_GET['g_name'];
                        $sql = "insert into gender (g_name) values ('$g_name')";
                        echo $sql;
                        include 'connectdb.php';
                        mysqli_query($conn,$sql);
                        mysqli_close($conn);
                        echo "เพิ่มเพศ $g_name เรียบร้อยแล้ว<br>";
                        echo '<a href="gender_list.php">แสดงเพศทั้งหมด</a>';
                    }else{
                ?>
                    <form class="form-horizontal" role="form" name="gender_add" action="<?php echo $_SERVER['PHP_SELF']?>">
